...
class Config {
 ...
 public:
  ...
  bool gene_invariant = false, generational_statistics = true, generational_solution = false,
       write_generational_population = false, verbose = false;
  int usePartialEvaluations = 1, useParallelGOM = 1, useParallelFOSOrder = 0, popUpdatesDuringGOM = 0,
      fixFOSOrderForPopulation = 0, AnalyzeFOS = 0, writeElitists = 0, saveEvaluations = 0, useForcedImprovements = 1,
      printHelp = 0, maximumNumberOfEvaluations = -1, maximumNumberOfGenerations = -1;
  double maximumNumberOfSeconds = -1;
  double vtr = 1e+308;
  size_t k = 1, s = 1, FOSIndex = 0;
  int GPUIndex = -1;
  ...
  int maximumNumberOfGOMEAs = 100, IMSsubgenerationFactor = 4, basePopulationSize = 2;
