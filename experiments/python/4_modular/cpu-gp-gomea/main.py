...
def main():
    ...
    grid_execution(cfg.MODULAR_DISTANCE_CPU, output_directory, dry_run=True)
    grid_execution(cfg.MODULAR_DOT_PRODUCT_CPU, output_directory, dry_run=True)
    grid_execution(cfg.MODULAR_GRAVITY_CPU, output_directory, dry_run=True)
