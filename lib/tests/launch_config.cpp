...
TEST_CASE("goblin::gp::gpu_evaluation::misc::kernel_dim::determine") {
    ...
    std::vector<TestCase> test_cases = {
        {32, KernelDim(32)},     {31, KernelDim(32)},      {63, KernelDim(64)},     {33, KernelDim(64)},
        {512, KernelDim(512)},   {513, KernelDim(544)},    {511, KernelDim(512)},   {1024, KernelDim(1024)},
        {1025, KernelDim(352)},  {1023, KernelDim(1024)},  {2048, KernelDim(1024)}, {2049, KernelDim(416)},
        {2047, KernelDim(1024)}, {100000, KernelDim(800)}, {73500, KernelDim(32)},
    };
...
TEST_CASE("goblin::gp::gpu_evaluation::misc::launch_config::determine") {
    ...
    std::vector<TestCase> test_cases = {
        {1, 1, KernelVersion::SingleBlock, std::nullopt,
         LaunchConfig(KernelConfig(KernelDim(1), KernelDim(32)), KernelConfig(), KernelVersion::SingleBlock)},
        {32, 1, KernelVersion::SingleBlock, std::nullopt,
         LaunchConfig(KernelConfig(KernelDim(32), KernelDim(32)), KernelConfig(), KernelVersion::SingleBlock)},
        {1, 32, KernelVersion::SingleBlock, std::nullopt,
         LaunchConfig(KernelConfig(KernelDim(1), KernelDim(32)), KernelConfig(), KernelVersion::SingleBlock)},
        {32, 32, KernelVersion::SingleBlock, std::nullopt,
         LaunchConfig(KernelConfig(KernelDim(32), KernelDim(32)), KernelConfig(), KernelVersion::SingleBlock)},
        {1, 1025, KernelVersion::SingleBlock, std::nullopt,
         LaunchConfig(KernelConfig(KernelDim(1), KernelDim(1024)), KernelConfig(), KernelVersion::SingleBlock)},
        {32, 1025, KernelVersion::SingleBlock, std::nullopt,
         LaunchConfig(KernelConfig(KernelDim(32), KernelDim(1024)), KernelConfig(), KernelVersion::SingleBlock)},
        {1, 4096, KernelVersion::SingleBlock, std::nullopt,
         LaunchConfig(KernelConfig(KernelDim(1), KernelDim(1024)), KernelConfig(), KernelVersion::SingleBlock)},
        {2048, 100000, KernelVersion::SingleBlock, std::nullopt,
         LaunchConfig(KernelConfig(KernelDim(2048), KernelDim(1024)), KernelConfig(), KernelVersion::SingleBlock)},
        {1, 1, KernelVersion::DynamicBlock, 1,
         LaunchConfig(KernelConfig(KernelDim(1), KernelDim(32)), KernelConfig(), KernelVersion::SingleBlock)},
        {32, 1, KernelVersion::DynamicBlock, 32,
         LaunchConfig(KernelConfig(KernelDim(32), KernelDim(32)), KernelConfig(), KernelVersion::SingleBlock)},
        {32, 1, KernelVersion::DynamicBlock, 64,
         LaunchConfig(KernelConfig(KernelDim(32, 2), KernelDim(32)), KernelConfig(KernelDim(32), KernelDim(32)),
                      KernelVersion::DynamicBlock)},
        {1, 32, KernelVersion::DynamicBlock, 1,
         LaunchConfig(KernelConfig(KernelDim(1), KernelDim(32)), KernelConfig(), KernelVersion::SingleBlock)},
        {32, 32, KernelVersion::DynamicBlock, 64,
         LaunchConfig(KernelConfig(KernelDim(32, 2), KernelDim(32)), KernelConfig(KernelDim(32), KernelDim(32)),
                      KernelVersion::DynamicBlock)},
        {1, 1025, KernelVersion::DynamicBlock, 1,
         LaunchConfig(KernelConfig(KernelDim(1), KernelDim(1024)), KernelConfig(), KernelVersion::SingleBlock)},
        {32, 1025, KernelVersion::DynamicBlock, 128,
         LaunchConfig(KernelConfig(KernelDim(32, 4), KernelDim(288)), KernelConfig(KernelDim(32), KernelDim(32)),
                      KernelVersion::DynamicBlock)},
        {1, 4096, KernelVersion::DynamicBlock, 120,
         LaunchConfig(KernelConfig(KernelDim(1, 120), KernelDim(64)), KernelConfig(KernelDim(1), KernelDim(128)),
                      KernelVersion::DynamicBlock)},
        {2048, 100000, KernelVersion::DynamicBlock, 100,
         LaunchConfig(KernelConfig(KernelDim(2048), KernelDim(1024)), KernelConfig(), KernelVersion::SingleBlock)},
    };
    ...
    for (auto&& [i, tc] : std::views::enumerate(std::as_const(test_cases))) {
        ...
        LaunchConfig result =
            LaunchConfig::determine(tc.kernel_version, tc.num_solutions, tc.num_datapoints, 0, tc.num_sms);
