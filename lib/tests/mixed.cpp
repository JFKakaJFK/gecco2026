...
TEST_CASE("goblin::methods::mixed") {
    ...
    std::vector<IMSOptions> ims_options{
        IMSOptions(),
        // IMSOptions(/* initial_population_size */ 10, /* max_num_populations */ 1) // too flaky across compilers -
        // this is a test of some method options, not a performance baseline comparison...
    };
