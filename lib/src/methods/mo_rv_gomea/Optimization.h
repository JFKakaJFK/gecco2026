...
#pragma once
#ifndef _MO_RV_GOMEA_OPTIMIZATION_H
#define _MO_RV_GOMEA_OPTIMIZATION_H
...
inline short black_box_evaluations, /* Whether full (black-box) evaluations must always be performed. */
...
inline int problem_index,           /* The index of the optimization problem. */
