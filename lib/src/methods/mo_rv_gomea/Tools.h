 ...
 */
#pragma once
#ifndef _MO_RV_GOMEA_TOOLS_H
#define _MO_RV_GOMEA_TOOLS_H
...
double* matrixVectorPartialMultiplication(double** matrix,
                                          double* vector,
                                          int n0,
                                          int n1,
...
inline int64_t random_seed, /* The seed used for the random-number generator. */
