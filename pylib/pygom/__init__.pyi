...
class PyGPInstance(GPInstanceBase):
    def __init__(
        ...
        ctx: GPContext,
        evaluate: Callable[
            [Callable[[Arr2D[float]], Optional[Arr2D[float]]], List[str], int],
...
class classic:  # Proxy class that introduces typings for the *submodule* classic
    ...
    class TournamentSelection(classic.SelectionStrategyBase):
        def __init__(
    ...
    class TruncationSelection(classic.SelectionStrategyBase):
        def select(
            self,
            rng: Rng,
            fitness: FitnessBase,
    ...
    class Rand1Bin(classic.DEStrategyBase):
        def __init__(
            self,
            f: float = 0.8,
            cr: float = 0.9,
    ...
    class ESStrategyParameters:
        strategy: ESStrategy = ESStrategy()
        parameters: Vec[float] = Vec < float > ()
    ...
    class RingTopology(classic.PSOTopologyBase):
    ...
    class PSOState:
        velocity: Vec[float] = Vec < float > ()
        previous_best: Vec[float] = Vec < float > ()
    ...
    class CombinedCrossover(classic.DiscreteCrossoverBase):
        @overload
        def __init__(
            self,
    ...
    class CombinedMutation(classic.DiscreteMutationBase):
        @overload
        def __init__(
            self,
    ...
    class Chained(classic.GPVariationOperatorBase):
        @overload
        def __init__(
    ...
    class SubtreeCrossover(classic.GPVariationOperatorBase):
        def apply(
            self,
            rng: Rng,
            problem: InstanceBase,
    ...
    class SubtreeMutation(classic.GPVariationOperatorBase):
    ...
    class ConstantMutation(classic.GPVariationOperatorBase):
    ...
    class StandardGP(classic.EABase):
        def __init__(
            self,
...
class voronoi:  # Proxy class that introduces typings for the *submodule* voronoi
    ...
    class CustomCrossover(classic.DiscreteCrossoverBase):
    ...
    class CustomMutation(classic.DiscreteMutationBase):
        def __init__(self) -> None:
            """Autogenerated default constructor"""
            pass

    class ColorMixCrossover(classic.DiscreteCrossoverBase):
        """/ Idea:
    ...
    class PositionMixCrossover(classic.DiscreteCrossoverBase):
        """/ Idea:
