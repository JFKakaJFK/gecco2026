...
class InstanceBase:
    ...
    def solution_cache_key(self, solution: SolutionBase) -> CacheKey:  # overridable
        pass
...
class CachedInstanceBase(InstanceBase):
...
class Tracked(InstanceBase):
    ...
    def solution_cache_key(self, solution: SolutionBase) -> CacheKey:
        pass
