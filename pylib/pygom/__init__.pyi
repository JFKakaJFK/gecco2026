...
class Subset:
    ...
    def distance(self, other: Subset) -> float:
        pass
...
class RvOptions:
    ...
    enable_partial_ams_for_full_fos: bool = True
    use_no_improvement_counts: bool = False
...
class RvState:
    def __init__(self, options: RvOptions) -> None:
        pass
    ...
    enable_partial_ams: bool
    num_clusters: int
    num_continuous: isize
    solutions_to_evaluate: List[int]
    improved_indices: List[List[int]]
    eval_subsets: List[
        Subset
    ...
    # per cluster data
    cluster_active: Array[bool]
    ms_active: Array[bool]
    distribution_multipliers: List[Array[float]]
    num_oob: List[Array[int]]
    num_samples: List[Array[int]]
    l: List[List[Mat[float]]]
    subsets: List[FOS]
    mean: List[Vec[float]]
    mean_shift: List[Vec[float]]
    cov: List[Mat[float]]
    any_improved: List[int]
    no_improvement_stretch: List[int]  # per cluster
    solution_nis: List[int]  # per solution
    solution_improved: List[bool]
    no_improvement_counts: List[
        int
