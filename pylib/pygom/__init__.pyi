...
class MOFitness:
    ...
    def log(self, os: io.IOBase, quality: MOFitness.Quality) -> None:
        pass

    def format(self, quality: MOFitness.Quality) -> str:
        pass
    ...
    def cmp(
        self,
        lhs: MOFitness.Quality,
        rhs: MOFitness.Quality,
    ...
    def worst(self) -> MOFitness.Quality:
        pass
...
class ArchiveBase:
    ...
    def fitness(self) -> Fitness:  # overridable (pure virtual)
        pass
...
class IMSOptions:
    ...
    restart_stale_populations: bool = True
...
class SRProblem(GPInstanceBase):
    ...
    linear_scaling: bool
    objectives: List[str]
    x_train: Arr2D[Scalar]
    y_train: Arr2D[Scalar]
    var_y_train: Array[Scalar]
    x_test: Arr2D[Scalar]
    y_test: Arr2D[Scalar]
    var_y_test: Array[Scalar]
