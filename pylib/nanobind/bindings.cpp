...
void py_init_module_pygoblin(nb::module_& m) {
  ...
  auto pyClassSubset =
      ...
      .def("empty",
          &goblin::Subset::empty)
      .def("distance",
          &goblin::Subset::distance, nb::arg("other"))
      .def("merge",
  ...
  auto pyClassRvOptions =
      nb::class_<goblin::RvOptions>
          (m, "RvOptions", "")
      .def("__init__", [](goblin::RvOptions * self, bool enabled = true, bool intron_aware = true, bool init_ams_from_population_mean = true, bool randomize_ams_indices = false, usize num_forced_improvement_tries = 8, usize max_nis = 20, double selection_percentile = 0.35, double p_accept = 0.05, CType delta_ams = 2.0, CType eta_ams = 1.0, CType eta_cov = 1.0, CType std_deviation_ratio_threshold = 1.0, CType distribution_multiplier_decrease = 0.9, CType distribution_multiplier_increase = 1.0 / 0.9, CType min_distribution_multiplier = 1e-10)
      {
      ...
      nb::arg("enabled") = true, nb::arg("intron_aware") = true, nb::arg("init_ams_from_population_mean") = true, nb::arg("randomize_ams_indices") = false, nb::arg("num_forced_improvement_tries") = 8, nb::arg("max_nis") = 20, nb::arg("selection_percentile") = 0.35, nb::arg("p_accept") = 0.05, nb::arg("delta_ams") = 2.0, nb::arg("eta_ams") = 1.0, nb::arg("eta_cov") = 1.0, nb::arg("std_deviation_ratio_threshold") = 1.0, nb::arg("distribution_multiplier_decrease") = 0.9, nb::arg("distribution_multiplier_increase") = 1.0 / 0.9, nb::arg("min_distribution_multiplier") = 1e-10
      )
  ...
  auto pyClassRvState =
      ...
      .def("perform_generation",
          &goblin::RvState::perform_generation, nb::arg("rng"), nb::arg("archive"), nb::arg("problem"), nb::arg("solutions"), nb::arg("parents"), nb::arg("solution_clusters"), nb::arg("cluster_solutions"), nb::arg("options"), nb::arg("linkage_model"))
      .def("converged",
          &goblin::RvState::converged, nb::arg("options"))
      .def("select_and_learn_linkage",
          &goblin::RvState::select_and_learn_linkage, nb::arg("rng"), nb::arg("archive"), nb::arg("problem"), nb::arg("solutions"), nb::arg("cluster_solutions"), nb::arg("options"), nb::arg("linkage_model"))
      .def("should_accept",
          &goblin::RvState::should_accept, nb::arg("rng"), nb::arg("fitness"), nb::arg("archive"), nb::arg("options"), nb::arg("solution"), nb::arg("parent"), nb::arg("objective").none(), nb::arg("strict"))
      .def("gom_step",
          &goblin::RvState::gom_step, nb::arg("rng"), nb::arg("archive"), nb::arg("problem"), nb::arg("solutions"), nb::arg("parents"), nb::arg("solution_clusters"), nb::arg("cluster_solutions"), nb::arg("options"), nb::arg("subset_orders"), nb::arg("subset_idx"), nb::arg("ams_indices"))
      .def("full_ams",
          &goblin::RvState::full_ams, nb::arg("rng"), nb::arg("archive"), nb::arg("problem"), nb::arg("solutions"), nb::arg("parents"), nb::arg("solution_clusters"), nb::arg("options"), nb::arg("ams_indices"))
      .def("forced_improvements",
          &goblin::RvState::forced_improvements, nb::arg("rng"), nb::arg("archive"), nb::arg("problem"), nb::arg("solutions"), nb::arg("parents"), nb::arg("solution_clusters"), nb::arg("options"))
      ...
      .def_rw("eval_subsets", &goblin::RvState::eval_subsets, "pointers because 1. we want to avoid copies and 2. the view should be nullable")
      ...
      .def_rw("no_improvement_counts", &goblin::RvState::no_improvement_counts, "per solution (count to not penalize inactive solutions)")
  ...
  auto pyClassMixedGOMEA =
      nb::class_<goblin::MixedGOMEA, goblin::MethodBase>
          (m, "MixedGOMEA", "")
      .def(nb::init<goblin::PopulationOptions, goblin::RvOptions, goblin::IMSOptions, std::shared_ptr<goblin::LinkageModelBase>, std::shared_ptr<goblin::LinkageModelBase>, std::string>(),
          nb::arg("population_options") = goblin::PopulationOptions(), nb::arg("rv_options") = goblin::RvOptions(), nb::arg("ims_options") = goblin::IMSOptions(), nb::arg("discrete_model") = std::make_shared<goblin::LinkageTreeFOS>(), nb::arg("continuous_model") = std::make_shared<goblin::FullFOS>(), nb::arg("repr") = "aos")
      .def("run",
