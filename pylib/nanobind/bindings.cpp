...
public:
    ...
    void reject(const goblin::SolutionBase & backup, bool always_inherit_continuous, std::optional<std::reference_wrapper<const goblin::Subset>> subset = std::nullopt) override
    {
        NB_OVERRIDE_NAME(
            "reject", // function name (python)
...
void py_init_module_pygoblin(nb::module_& m) {
  ...
  auto pyClassSolutionBase =
      ...
      .def("reject",
          &goblin::SolutionBase::reject, nb::arg("backup"), nb::arg("always_inherit_continuous"), nb::arg("subset").none() = nb::none())
      ;
  ...
  auto pyClassSRProblem =
      ...
      .def(nb::init<goblin::GPContext, Arr2D<CType>, Arr2D<CType>, std::optional<Arr2D<CType>>, std::optional<Arr2D<CType>>, std::variant<std::string, std::vector<std::string>>, std::optional<usize>, bool, std::optional<AnyInit>, CType, CType, std::optional<std::vector<CType>>, std::string, CType, CType, std::optional<bool>>(),
          nb::arg("ctx"), nb::arg("x_train"), nb::arg("y_train"), nb::arg("x_test").none() = nb::none(), nb::arg("y_test").none() = nb::none(), nb::arg("objectives") = "mse", nb::arg("objectives_to_optimize").none() = nb::none(), nb::arg("linear_scaling") = true, nb::arg("init").none() = nb::none(), nb::arg("constant_init_lower_bound") = -1.0, nb::arg("constant_init_upper_bound") = 1.0, nb::arg("target_objectives").none() = nb::none(), nb::arg("gradient_mode") = "central", nb::arg("gradient_epsilon") = 1e-5, nb::arg("archive_epsilon") = 1e-6, nb::arg("always_inherit_continuous").none() = nb::none())
      .def("num_discrete",
