...
public:
    ...
    void crossover_masks(Rng & rng, const goblin::SolutionBase & parent1, const goblin::SolutionBase & parent2, goblin::Subset & mask1, goblin::Subset & mask2) const override
    {
        NB_OVERRIDE_PURE_NAME(
...
void py_init_module_pygoblin(nb::module_& m) {
  ...
  auto pyClassPyGPInstance =
      ...
      .def("num_discrete",
          &goblin::PyGPInstance::num_discrete)
      .def("discrete_domain_sizes",
          &goblin::PyGPInstance::discrete_domain_sizes)
      .def("num_continuous",
          &goblin::PyGPInstance::num_continuous)
      .def("continuous_lower_bounds",
  ...
  { // <namespace classic>
      ...
      auto pyNsclassic_ClassEABase =
          ...
          .def("run",
              &goblin::classic::EABase::run, nb::arg("problem"), nb::arg("budget"), nb::arg("seed").none(), nb::arg("population_size").none())
          .def("current_generation",
      ...
      auto pyNsclassic_ClassDiscreteCrossoverStrategyBase =
          nb::class_<goblin::classic::DiscreteCrossoverStrategyBase, goblin::classic::DiscreteCrossoverStrategyBase_trampoline>
              (pyNsclassic, "DiscreteCrossoverStrategyBase", "/ Strategy used to generate the crossover masks to exchange information between two parents")
          .def(nb::init<>()) // implicit default constructor
          .def("crossover_masks",
              &goblin::classic::DiscreteCrossoverStrategyBase::crossover_masks, nb::arg("rng"), nb::arg("parent1"), nb::arg("parent2"), nb::arg("mask1"), nb::arg("mask2"))
          ;
      ...
      auto pyNsclassic_ClassUniformCrossover =
          ...
          .def("crossover_masks",
              &goblin::classic::UniformCrossover::crossover_masks, nb::arg("rng"), nb::arg("parent1"), nb::arg("parent2"), nb::arg("mask1"), nb::arg("mask2"))
          ;
      ...
      auto pyNsclassic_ClassNPointCrossover =
          ...
          .def(nb::init<usize>(),
              nb::arg("num_points") = 1)
          .def("crossover_masks",
              &goblin::classic::NPointCrossover::crossover_masks, nb::arg("rng"), nb::arg("parent1"), nb::arg("parent2"), nb::arg("mask1"), nb::arg("mask2"))
          ;
      ...
      auto pyNsclassic_ClassSimpleGA =
          ...
          .def("__init__",
              [](goblin::classic::SimpleGA * self, usize population_size = 100, double p_mutation = 0.1, const std::optional<const std::shared_ptr<goblin::classic::DiscreteCrossoverStrategyBase>> & crossover_strategy = std::nullopt, bool steady_state = true, const std::optional<const std::shared_ptr<goblin::classic::SelectionStrategyBase>> & selection_strategy = std::nullopt)
              {
                  auto ctor_wrapper = [](goblin::classic::SimpleGA* self, usize population_size = 100, double p_mutation = 0.1, std::shared_ptr<goblin::classic::DiscreteCrossoverStrategyBase> crossover_strategy = std::make_shared<goblin::classic::UniformCrossover>(), bool steady_state = true, std::shared_ptr<goblin::classic::SelectionStrategyBase> selection_strategy = std::make_shared<goblin::classic::TournamentSelection>(4)) ->  void
                  {
                      new(self) goblin::classic::SimpleGA(population_size, p_mutation, crossover_strategy, steady_state, selection_strategy); // placement new
                  };
                  auto ctor_wrapper_adapt_mutable_param_with_default_value = [&ctor_wrapper](goblin::classic::SimpleGA * self, usize population_size = 100, double p_mutation = 0.1, const std::optional<const std::shared_ptr<goblin::classic::DiscreteCrossoverStrategyBase>> & crossover_strategy = std::nullopt, bool steady_state = true, const std::optional<const std::shared_ptr<goblin::classic::SelectionStrategyBase>> & selection_strategy = std::nullopt)
                  {
                      ...
                      const std::shared_ptr<goblin::classic::DiscreteCrossoverStrategyBase>& crossover_strategy_or_default = [&]() -> const std::shared_ptr<goblin::classic::DiscreteCrossoverStrategyBase> {
                      ...
                      ctor_wrapper(self, population_size, p_mutation, crossover_strategy_or_default, steady_state, selection_strategy_or_default);
                  };

                  ctor_wrapper_adapt_mutable_param_with_default_value(self, population_size, p_mutation, crossover_strategy, steady_state, selection_strategy);
              },
              nb::arg("population_size") = 100, nb::arg("p_mutation") = 0.1, nb::arg("crossover_strategy").none() = nb::none(), nb::arg("steady_state") = true, nb::arg("selection_strategy").none() = nb::none(),
          ...
          .def("mutate",
              &goblin::classic::SimpleGA::mutate,
              nb::arg("rng"), nb::arg("problem"), nb::arg("solution"), nb::arg("any_active_changed"),
